//programa hecho por Angel Alexander Granados flores
//carnet gf18011
...
void principio(){
	...
	int opcion;
	do{
		//mostra en pantalla el menu con las respectivas opciones
		system ("cls");
		cout<<"\n\n\t\t\t------------------------------------------"<<endl;
		cout<<"\t\t\t||\t   MENU PRINCIPAL\t\t||"<<endl;
		cout<<"\t\t\t||\t\t                  \t||"<<endl;
		cout<<"\t\t\t||1. Juego de las Torres hanoi\t\t||"<<endl;
		cout<<"\t\t\t||2. orden de 100 numero aleatorios\t||"<<endl;
		cout<<"\t\t\t||3. Salir          \t\t\t||"<<endl;
		cout<<"\t\t\t------------------------------------------"<<endl;
		
		//Leer la opcion elejida por el ususario
		cout << "\nIngrese opcion requerida: ";
		cin >> opcion;
		...
		switch(opcion){
			...
			case 3:
				system ("cls");
	            cout<<"Gracias por jugar, Feliz Dia."<<endl;
				repite = false;
				break;
...
void salir(){
 ...
 system("cls");
 linea(27);
 cout<<cr<<cr<<cr<<cr<<cr<<cr<<" Angel Granados "<<"";
 linea(6);
 cout<<cr<<cr<<cr<<cr<<cr<<cr<<cr<<cr<<cr<<cr<<cr<<" 2018 ";
 linea(10);
 linea(27);
 cout<<cr<<"   Gracias por jugar     "<<cr<<endl;
 cout<<cr<<"      feliz dia         "<<cr<<endl;
 linea(27);
 getchar();
